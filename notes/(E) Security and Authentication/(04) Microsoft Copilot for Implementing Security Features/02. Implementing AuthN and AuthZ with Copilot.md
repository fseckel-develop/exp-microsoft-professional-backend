...
Follow this step-by-step guide to use Microsoft Copilot to set up secure authentication and authorisation for your application.
...
2. Configure Role-Based Access Control (RBAC)
	- Step: Prompt Copilot with:
		Write authorisation rules for different user roles in ASP.NET Core.
	- Example: Restrict access to admin features based on roles.

3. Apply Authorisation Policies
	- Step: Type a prompt like:
		Add authorisation policies to secure specific API endpoints.
