...
static void SerializeToFiles()
{
    ...
    using (FileStream fs = new FileStream("Data/person.dat", FileMode.Create))
    {
    ...
    using (StreamWriter writer = new StreamWriter("Data/person.xml"))
    {
    ...
    File.WriteAllText("Data/person.json", jsonString);
